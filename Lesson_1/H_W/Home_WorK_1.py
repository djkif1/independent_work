...
# var_1 = int(input("Enter the numbers :"))
# print(var_1)
...
# var_1 = int(input("What year were you born? :"))
# var_2 = int(input("Enter the current year? :"))
# var_3 =input("Enter your name? :")
# print(var_3, f"you are now  {var_2 - var_1} years old")
...
# var_1 = int(input("Enter the temperature in Celsius :"))
# far= var_1 * 1.8 +32
...
# var_1 = int(input("Enter the temperature in Fahrenheit :"))
# far= (var_1  -32) / 1.8
# print(f"Temperature in Celsius : {far}")
...
# kat= float(input("Введіть довжину катетів :"))
# gip = (kat**2*2)**0.5
# print(gip)
...
# n_scholl = int(input("Введіть кількість учнів: "))
# k_apple = int(input("Введіть кількість яблук: "))
# appe = k_apple // n_scholl
# n = k_apple % n_scholl
# print(f"Школярі отримали по {appe} яблук, в кошику залишилось {n} яблук")
...
# s = int(input("Введіть кількість журавликів"))
# p = s//4
# print(f"Петро зробив {p} журавликів.")
# print(f"Катя зробила {2 * p} журавликів.")
# print(f"Сергій зробив {p} журавликів.")
...
# salary = int(input("Введіть свою ЗП за 3 місяці: "))
# persent = int(input("Введіть процент : "))
#
# sumary = ((salary/100) * persent) + 4422
# print(sumary)
